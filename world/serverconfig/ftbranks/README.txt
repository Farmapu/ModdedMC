...
Last README file update: Sat Jul 15 15:18:55 BST 2023
...
command.ancient_mob
command.ancient_mob.target
command.ancient_mob.target.ancient
command.apoth
command.apoth.gem
...
command.mob_enchanting
command.mob_enchanting.clear
command.mob_enchanting.clear.target
command.mob_enchanting.give
command.mob_enchanting.give.target
command.mob_enchanting.give.target.MobEnchantment
command.mob_enchanting.give.target.MobEnchantment.level
command.modernfix
